...
public class RouteMapper {
    ...
    public static RouteResDto toDto(RouteDomain entity, Integer numWaypoints ) {
        ...
        return RouteResDto.builder()
                ...
                .hasOutboundImage(entity.getOutboundImageData() != null && entity.getOutboundImageData().length > 0)
                .hasReturnImage(entity.getReturnImageData() != null && entity.getReturnImageData().length > 0)
